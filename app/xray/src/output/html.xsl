<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet version="2.0" exclude-result-prefixes="xray xdmp" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xray="http://github.com/robwhitby/xray" xmlns:xdmp="http://marklogic.com/xdmp" xmlns:error="http://marklogic.com/xdmp/error" xmlns:xs="http://www.w3.org/2001/XMLSchema">
...
declare %test:case function <span class="f">node-should-equal-foo</span> ()
{
  ...
  <xsl:function name="xray:url" as="xs:string">
    ...
    <xsl:value-of select="concat('?dir=', $test-dir,                                  '&amp;modules=', encode-for-uri($module),                                  '&amp;tests=', encode-for-uri($test),                                  '&amp;format=', $format)"/>
  </xsl:function>
